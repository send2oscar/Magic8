    ...
    <div className="space-y-6">
      <Card className="hud-frame bg-card/50 p-6">
        <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
          <div className="flex items-center gap-2"><Settings2 className="h-5 w-5 text-secondary" /><div><div className="flex flex-wrap items-center gap-2"><h2 className="font-bold">CREDIT POLICY</h2><span className="rounded border border-secondary/50 bg-secondary/10 px-2 py-0.5 text-[10px] font-bold tracking-wide text-secondary">ALL USERS</span></div><p className="mt-1 text-xs text-muted-foreground">These site-wide values are enforced by the server for every user. Credits are deducted only after a successful generation.</p></div></div>
      ...
      <Card className="hud-frame bg-card/50 p-6">
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3"><div><div className="flex flex-wrap items-center gap-2"><h2 className="font-bold">FIXED CREDIT PACKAGES</h2><span className="rounded border border-secondary/50 bg-secondary/10 px-2 py-0.5 text-[10px] font-bold tracking-wide text-secondary">ALL USERS</span></div><p className="mt-1 text-xs text-muted-foreground">Shared checkout choices shown to every user. The USD checkout amount is derived from the active policy and cannot be edited per package.</p></div><Button type="button" variant="outline" onClick={() => void addPackage()} disabled={savePackage.isPending} className="border-secondary/60 text-secondary"><Plus className="mr-2 h-4 w-4" /> ADD PACKAGE</Button></div>
      ...
      <Card className="hud-frame bg-card/50 p-6">
        <div className="mb-5 flex items-center gap-2"><ReceiptText className="h-5 w-5 text-accent" /><div><div className="flex flex-wrap items-center gap-2"><h2 className="font-bold">PAYPAL PAYMENT RECORDS</h2><span className="rounded border border-secondary/50 bg-secondary/10 px-2 py-0.5 text-[10px] font-bold tracking-wide text-secondary">ALL USERS</span></div><p className="mt-1 text-xs text-muted-foreground">All-user return-page capture records, including incomplete and failed PayPal checkouts.</p></div></div>
